...
3. [**In Depth: Registered Users**](/users/being-a-user.md)** - **Everything States need to know in how to use and setup the software. This section also details the different types of registered user and how they can perform their roles.
